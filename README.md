...
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| Login                 | Enter your credentials to sign-in.                                                                                                                                                              | ![screenshot](/screenshots/Sign%20In.png)                                                 |
| Sign-up               | Enter the user details, choose the suitable user category and click Sign-Up to create a new account.                                                                                            | ![screenshot](/screenshots/Sign%20Up.png)                                                 |
| Dashboard             | Click on a button to proceed.                                                                                                                                                                   | ![screenshot](/screenshots/Dashboard.png)                                                 |
| Contacts              | It enlists the emergency contacts added. Click on the call icon to directly place a call.                                                                                                       | ![screenshot](/screenshots/EmergencyContacts.png) ![screenshot](/screenshots/Call.png)    |
| Add Contacts          | Enter details and click add to create a new Contact.                                                                                                                                            | ![screenshot](/screenshots/AddContact.png)                                                |
| Medicines             | It enlists the medicines added along with the details. The app also sends you a notification at the given time to remind you to take the medicine.                                              | ![screenshot](/screenshots/Medicines.png)  ![screenshot](/screenshots/Notification.png)   |
| Add Medicines         | Enter details and click add to set the reminder.                                                                                                                                                | ![screenshot](/screenshots/Add%20Medicine.png)                                            |
| Organisation List     | Displays the list of ADA compliant organisations you can visit. Click on Visit to schedule an appointment in that organisation. Click on a card to view more.                                   | ![screenshot](/screenshots/Orgs.png)                                                      |
| Organisation Details  | It shows the details of the organisation. Click on the view on map link to check the location of the organisation. It also enlists the resources it has to offer. Click on a card to view more. | ![screenshot](/screenshots/Org%20Details.png) ![screenshot](/screenshots/Maps.png)        |
| Resource Details      | Shows all details of the individual resource.                                                                                                                                                   | ![screenshot](/screenshots/ResourceDetails.png)                                           |
| Schedule Appointments | Enter details and click schedule.                                                                                                                                                               | ![screenshot](/screenshots/Schedule%201.png) ![screenshot](/screenshots/Schedule%201.png) |
| Appointment List      | Shows a list of all the scheduled appointments.                                                                                                                                                 | ![screenshot](/screenshots/Appointments.png)                                              |
| Appointment Details   | Shows details of the individual appointment along with volunteer details (if assigned)                                                                                                          | ![screenshot](/screenshots/AppointmentDetails.png)                                        |
